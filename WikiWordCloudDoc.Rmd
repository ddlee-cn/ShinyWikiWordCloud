...
## Intro
This simple shiny application build a word cloud for the Intro section of wikipedia pages.
...
## Example: [Machine Learning]('https://en.wikipedia.org/wiki/Machine_learning') Page
...
## Issues
"invalid 'cex' value" error may raise for some pages, as not all html structure of wiki pages are exactly the same.
